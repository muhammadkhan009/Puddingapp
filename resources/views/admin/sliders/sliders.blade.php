        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
                ...
                <h3>Slides</h3>
                    <a href="{{route('add-slider')}}" class="btn btn-xl btn-primary">Add Slide</a>
                </div>
                @csrf
                    <table id="zipscodes" class="table table-bordered table-hover" >
                        ...
                        <tr>
                            <td>{{$loop->index+1}}</td>
                            <td>{{$slide->name}}</td>
                            <td style="text-align:center;"><img src="{{asset('public/uploads/sliders/bg').'/'.$slide->bg_image}}" width="50"></td>
                            <td style="text-align:center;"><img src="{{asset('public/uploads/sliders/front').'/'.$slide->front_image}}" width="50" ></td>
                            <td><a href="{{route('edit-slide', ['id'=>$slide->id])}}" class="btn btn-block btn-primary">EDIT</a></td>
                            <td><button type="submit" class="btn btn-danger btn-primary" value="{{$slide->id}}" title="Delete Trainee" >
